// AUTO-GENERATED by `dotnet run --project EggIncognito.Tooling -- emit-types`.
// Source of truth: the C# records in EggIncognito.Tooling/Dashboard. Do NOT edit by hand;
