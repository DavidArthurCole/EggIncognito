// Inline SVG icon set for the capture dashboard. One source of truth so the toolbar, notification
// center, device cards, and format controls all use consistent, crisp, theme-aware icons (they
// inherit `currentColor`, so a button's color drives the icon color). No external dependency, works
// offline. Paths are 24x24, stroke-based (Lucide-style geometry, hand-inlined).
