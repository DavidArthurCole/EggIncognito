...
//
// Run: `dotnet run --project EggIncognito -- emit-types`
...
public static class TypeEmitter
{
    ...
    public static int Run(string repoRoot)
    {
        ...
        sb.AppendLine("// AUTO-GENERATED by `dotnet run --project EggIncognito -- emit-types`.");
        sb.AppendLine("// Source of truth: the C# records in EggIncognito.Capture. Do NOT edit by hand;");
        ...
        var outPath = Path.Combine(repoRoot, "EggIncognito", "wwwroot", "capture", "types.d.ts");
