...
public sealed class ProviderTests
{
    ...
    [Fact]
    public void Hen_house_ac_is_egg_laying_not_hab_capacity()
    {
        Assert.Equal(EffectTarget.EggLayingRate, Provider.Resolve("research", "hen_house_ac")!.Target);
    }

    [Fact]
    public void Tachyon_deflector_is_coop_egg_laying_not_hatch()
    {
        Assert.Equal(EffectTarget.CoopEggLaying, Provider.Resolve("artifact", "TACHYON_DEFLECTOR:4:3")!.Target);
    }
}
