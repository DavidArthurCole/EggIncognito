...
{
    [Fact]
    public void Add_sums_contributions_onto_seed()
    {
        Assert.Equal(17, Folding.Fold(CombineMode.Add, 0, [2, 5, 10]));
    }

    [Fact]
    public void Mul_multiplies_contributions()
    {
        Assert.Equal(1000, Folding.Fold(CombineMode.Mul, 1, [10, 100]));
    }
