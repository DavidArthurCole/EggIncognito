...
public class HatcheryPieceClassifierTests {
    ...
    public void DarkmatterRings_AreRings(float a, float b, float c, float d, float e, float f) => Assert.Equal(Role.Ring, Classify(B(a, b, c, d, e, f)));
    ...
    public void VisionShells_AreShells(float a, float b, float c, float d, float e, float f) => Assert.Equal(Role.Shell, Classify(B(a, b, c, d, e, f)));
    ...
    public void AiTops_AreWorldPlaced(float a, float b, float c, float d, float e, float f) => Assert.Equal(Role.WorldPlaced, Classify(B(a, b, c, d, e, f)));
