...
public sealed class ApkTextureListerTests {
    ...
    public void Reads_a_named_texture_by_stem() {
        byte[] apk = Apk(("assets/textures-etc1png-med/b_icon_dilithium_bulb.png", "PNGDATA"));

        byte[]? bytes = ApkTextureLister.ReadStem(apk, "b_icon_dilithium_bulb");
    ...
    public void Unknown_stem_returns_null() {
        byte[] apk = Apk(("assets/textures-etc1png-med/b_icon_dilithium_bulb.png", "X"));
