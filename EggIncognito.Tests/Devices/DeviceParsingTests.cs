...
public class DeviceParsingTests {
    ...
    [Fact]
    public void IosAppVersion_Plist_FindsShortVersion() => Assert.Equal("1.35.8", DeviceParsing.IosAppVersion(Plist, "com.auxbrain.egginc"));

    [Fact]
    public void IosAppVersion_Csv_FindsShortVersion() => Assert.Equal("1.35.8", DeviceParsing.IosAppVersion(ListCsv, "com.auxbrain.egginc"));
    ...
    [Fact]
    public void IosAppVersion_BundleNotInstalled_ReturnsNull() => Assert.Null(DeviceParsing.IosAppVersion(Plist, "com.does.not.exist"));

    [Fact]
    public void IosAppVersion_Garbage_ReturnsNull() => Assert.Null(DeviceParsing.IosAppVersion("not xml or csv", "com.auxbrain.egginc"));
}
