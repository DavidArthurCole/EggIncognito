...
public class StoreCheckerProgressTests {
    ...
    public async Task UpToDate_WhenNoUpdateButton() {
        var runner = new FakeRunner(args => {
            ...
            return args.Any(a => a.Contains("cat")) ? new ProcessResult(0, UiNoUpdate, "") : new ProcessResult(0, "", "");
        });
    ...
    public async Task ProgressAnnouncesClimb_ThenUpdated() {
        ...
        var runner = new FakeRunner(args => {
            ...
            return args.Any(a => a.Contains("cat")) ? new ProcessResult(0, UiWithUpdate, "") : new ProcessResult(0, "", "");
        });
    ...
    [Fact]
    public void FindUpdateButtonCenter_NoUpdate_ReturnsNull() => Assert.Null(AndroidPlayStoreChecker.FindUpdateButtonCenter(UiNoUpdate));
