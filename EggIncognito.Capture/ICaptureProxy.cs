...
// Thin abstraction over the concrete proxy engine so the pre-1.0 Unobtanium API churn is
// contained behind one seam. The capture command depends only on this.
