...
public sealed class CaptureSession(string contentRoot, CaptureSessionOptions opts, Func<bool, ICaptureProxy>? proxyFactory = null) {
    private const string EidPlaceholder = "EI0000000000000000";

    private readonly string _contentRoot = contentRoot;
    private readonly CaptureSessionOptions _opts = opts;
