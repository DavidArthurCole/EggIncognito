...
// Identifies the proto type of an arbitrary captured base64 blob. Backs POST /api/tools/decode.
// Tries the bytes raw and (if they parse as an AuthenticatedMessage)
// unwrapped, returning the best-ranked Ei.* type + its JSON.
