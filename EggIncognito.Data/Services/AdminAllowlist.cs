...
// The set of Discord ids auto-promoted to admin on login (from Discord:AdminIds config). Bootstraps
// the first admin without DB editing; the allowlist stays authoritative for admin (a returning
