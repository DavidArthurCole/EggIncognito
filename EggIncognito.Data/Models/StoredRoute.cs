...
public class StoredRoute {
    ...
    [Column("raw_response")] public string? RawResponse { get; set; }

    [Column("path_param")] public bool PathParam { get; set; }

    [Column("path_param_only")] public bool PathParamOnly { get; set; }

    [Column("source")] public string Source { get; set; } = "yaml";
